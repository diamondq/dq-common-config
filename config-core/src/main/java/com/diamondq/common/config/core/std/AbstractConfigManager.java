...
public class AbstractConfigManager implements ConfigManager {
	...
	protected final String[]								mDefaultProfiles;
	...
	protected AbstractConfigManager(String pEnvironment, @NonNull String[] pProfiles, String pAppId,
	...
	public Config getConfig() {
		...
		Collection<BootstrapConfigSourceFactory> orderedFactories =
			InjectUtils.orderByPriority(mDefaultBootstrapSources);
