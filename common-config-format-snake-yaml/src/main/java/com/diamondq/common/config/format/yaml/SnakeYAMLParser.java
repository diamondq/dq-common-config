...
public class SnakeYAMLParser extends AbstractYAMLConfigParser implements ConfigParser {
    ...
    private static final NodeType sNodeType =
        NodeType.builder().isExplicitType(true).type(ConfigProp.builder().configSource("").value(SnakeYAMLParser.class.getName()).build()).build();
